                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-2 col-sm-12">
                    <select class="form-control" id="status_">
                      <option selected="" value="">请选择结算状态</option>
                  ...
                  <div class="form-group col-lg-4 col-sm-12">
                    <div class="input-group">
                      ...
                      <div style="width: 100%;float: left;height: 32px;">
                        <div class="row">
                          <div class="col-lg-5 col-sm-5 col-xs-5"><input type="text"style="height:32px;" class="Wdate form-control"  placeholder="选择开始时间" readonly="readonly" name="dateStart" id="dateStart" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'dateEnd\')}'})"></div>
                          <div class="col-lg-1 col-sm-1 col-xs-1 text-center" style="line-height:32px;">-</div>
                          <div class="col-lg-5 col-sm-5 col-xs-5"><input type="text" style="height:32px;" class="Wdate form-control"  placeholder="选择结束时间" readonly="readonly" name="dateEnd" id="dateEnd" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'dateStart\')}'})"></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script>
  ...
  ...mapActions([USER_SIGNOUT]),
    ...
    openImageProxy: function (event) {
      if (event.target.nodeName === 'BUTTON') {
        ...
        this.$router.replace({ path: '/selftranscationDetail/' + SettlementId+SettlementType})
  ...
  mounted:function () {
    ...
    $("#DataTable").dataTable({
      ...
      "ajax": {
        //"url": "/SettlementList",
        "url": store.state.baseUrl.data_serv_url+"/system/operatorSettlement/detailPage",
        "type": "POST",
        ...
        "data":function (d) {//d 是原始的发送给服务器的数据，默认很长。
          ...
          request_parames.type = status;
          request_parames.status = status_;
      ...
      "columns": [
        ...
        //操作列
        {
          ...
          "render": function (data,type,full,callback) {
            var datahtml='';
            datahtml+='<button class="btn btn-info btn-xs" SettlementId="'+full.acct_id+'" SettlementType="'+full.busName+'">详情</button>'
            return datahtml;
          }
        }
