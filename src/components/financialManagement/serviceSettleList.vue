           ...
           <div class="ibox-title">
             <div class="row">
               ...
               <div class="form-group col-lg-3 col-md-6 col-sm-8 col-xs-12">
                 <input class="form-control" placeholder="请输入服务单号/服务门店进行搜索" id="storeName">
               </div>
        ...
        methods: {
                  ...
                  openImageProxy: function (event) {
                    if (event.target.nodeName === 'BUTTON') {
                      ...
                      this.$router.replace({ path: '/serviceSettleDetail/'+ order })
...
//服务单列表
          ...
          $("#DataTable").dataTable({
            ...
            "ajax": {
//              "url": "/customerOrder",
              "url": store.state.baseUrl.data_serv_url+"/vip/cappServOrder/findPage_",
              "type": "POST",
            ...
            "columns": [
              ...
              },
              {
                "data": "ratio",//json
                "render": function (data,type,full,callback) {
                  var datahtml=Number(data*full.amount*0.01).toFixed(2);
                  return datahtml;
                }
              },
              { "data": "add_time" },
